...
*/
	public Student(int studentID, String studentName, int numOfSubjects, String enrolmentDate, Address studentAddress) {
...
*/
	...
	public void display() {
		...
		getStudentName() + " Details: " + "\n", "     ID:", getStudentID(), "     Name:", getStudentName(),"     Address:", getStudentAddress(), "     Number of Subjects:", getNumOfSubjects(), "     Grades for each Subject:\n\n", getGradesForEachSubject(), "     Average Grades:", getAverage(), "     Date of Enrolment:", getEnrolmentDate());
